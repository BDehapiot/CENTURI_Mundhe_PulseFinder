...
def show_data_widget(cell_data, all_id, myoii, pulse_data_path):
    ...
    def show_data(
        ...
        if pulse1_ti >= np.min(time_range): 
            ...
            p1_ti.text(pulse1_ti+0.25,0.8,'p1_ti',rotation=90)
            p1_ti.axis('off')            
        else:
        ...
        if pulse1_tf >= pulse1_ti: 
            ...
            p1_ti.text(pulse1_tf+0.25,0.8,'p1_tf',rotation=90)
            p1_tf.axis('off')           
        else:
        ...
        if pulse2_ti >= pulse1_tf: 
            ...
            p2_ti.text(pulse2_ti+0.25,0.8,'p2_ti',rotation=90)
            p2_ti.axis('off')            
        else:
        ...
        if (pulse2_ti >= pulse1_tf) and (
            ...
            p2_ti.text(pulse2_tf+0.25,0.8,'p2_tf',rotation=90)
            p2_tf.axis('off')            
        else:
        ...
        if pulse3_ti >= pulse2_tf: 
            ...
            p3_ti.text(pulse3_ti+0.25,0.8,'p3_ti',rotation=90)
            p3_ti.axis('off')            
        else:
        ...
        if (pulse3_ti >= pulse2_tf) and (
            ...
            p3_ti.text(pulse3_tf+0.25,0.8,'p3_tf',rotation=90)
            p3_tf.axis('off')            
        else:
